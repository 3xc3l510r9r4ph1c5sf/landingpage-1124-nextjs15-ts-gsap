...
import React, { useEffect, useLayoutEffect, useRef, useState, FC } from 'react';
...
// Registriere die ScrollTrigger-Plugin
...
const Header: FC = () => {
  ...
  useLayoutEffect(() => {
    ...
    // Optional: Weitere Animationen können hier hinzugefügt werden
    // Beispiel:
    // tl.to(buttonElement, { opacity: 1, duration: 1 });

    return () => {
      // Bereinige den ScrollTrigger beim Unmount
