    ...
    <main className="bg-mainbody-weg text-hero-dark">
      ...
      >
        ...
        <div
          ...
          "
        >
          {/* Replace '/design-process.png' with your actual hero or mockup image */}
          <Image
            fill
            src="/project1-hero.png"
            alt="Trainspot Hero Mockup"
        ...
        <div className="flex flex-col gap-[2.5rem] pt-12 md:pt-0 lg:mb-[500px]">
          ...
          <p className="card-paragraph">
            <strong>Project Name:</strong> Trainspot
            <br />
            <strong>Client:</strong> WBS for the Mein Bildungsraum project
            <br />
            <strong>Sector:</strong> Digital Education, Technology, Community
            Building
          </p>
          <p className="card-paragraph">
            <strong>Timeframe:</strong> [You can add specific dates or duration
            here]
            <br />
      ...
      <section className="max-w-[84.2rem] px-[0.63rem] pt-20 md:pl-[1.25rem] md:pr-[4.437rem] md:pt-[7.12rem] lg:mb-[200px] lg:p-[10rem_1.25rem_0rem_4.5625rem]">
        {/* Example of a big heading plus paragraphs, styled similarly to “Specialization” example */}
      ...
      >
        <div
          ...
          "
        >
          {/* Placeholder for a “Challenge” visual or infographic */}
          <Image
            fill
        ...
        <div className="flex flex-col gap-[1.9rem] md:gap-[3.15rem]">
          ...
          <ul className="list-disc ml-4 card-paragraph">
            <li>
              <strong>Fragmented Learning Landscape:</strong> Institutions and
              learners struggled to consolidate multiple courses, resources, and
              tracking in one place.
            </li>
            <li>
              <strong>Lack of Seamless Integration:</strong> Existing systems
              were siloed, complicating collaboration between educators.
            </li>
            <li>
              <strong>User Adoption:</strong> Less tech-savvy educators needed
              an easy-to-use platform to stay motivated.
            </li>
          </ul>
        </div>
      </section>
